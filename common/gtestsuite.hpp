...
TEST(common, MIXER_PARAM_VALUE)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::MIXER_PARAM_VALUE packet_in{};
    packet_in.flags = 101;
    packet_in.count = 18483;
    packet_in.index = 18587;
    packet_in.mixer_group = 168;
    packet_in.mixer_index = 18691;
    packet_in.mixer_sub_index = 235;
    packet_in.mixer_type = 46;
    packet_in.parameter_index = 18795;
    packet_in.param_type = 113;
    packet_in.param_array_size = 180;
    packet_in.param_id = to_char_array("MNOPQRSTUVWXYZA");
    packet_in.param_values = {{ 17.0, 18.0, 19.0, 20.0, 21.0, 22.0 }};

    mavlink::common::msg::MIXER_PARAM_VALUE packet1{};
    mavlink::common::msg::MIXER_PARAM_VALUE packet2{};
    ...
    EXPECT_EQ(packet1.mixer_group, packet2.mixer_group);
    EXPECT_EQ(packet1.mixer_index, packet2.mixer_index);
    EXPECT_EQ(packet1.mixer_sub_index, packet2.mixer_sub_index);
    EXPECT_EQ(packet1.mixer_type, packet2.mixer_type);
    EXPECT_EQ(packet1.parameter_index, packet2.parameter_index);
    EXPECT_EQ(packet1.param_type, packet2.param_type);
    EXPECT_EQ(packet1.param_array_size, packet2.param_array_size);
    EXPECT_EQ(packet1.param_id, packet2.param_id);
    EXPECT_EQ(packet1.param_values, packet2.param_values);
}

#ifdef TEST_INTEROP
TEST(common_interop, MIXER_PARAM_VALUE)
{
    mavlink_message_t msg;
    ...
    mavlink_mixer_param_value_t packet_c {
    ...
    mavlink_msg_mixer_param_value_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.mixer_group, packet2.mixer_group);
    EXPECT_EQ(packet_in.mixer_index, packet2.mixer_index);
    EXPECT_EQ(packet_in.mixer_sub_index, packet2.mixer_sub_index);
    EXPECT_EQ(packet_in.mixer_type, packet2.mixer_type);
    EXPECT_EQ(packet_in.parameter_index, packet2.parameter_index);
    EXPECT_EQ(packet_in.param_type, packet2.param_type);
    EXPECT_EQ(packet_in.param_array_size, packet2.param_array_size);
    EXPECT_EQ(packet_in.param_id, packet2.param_id);
    EXPECT_EQ(packet_in.param_values, packet2.param_values);
...
TEST(common, MIXER_PARAM_SET)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::MIXER_PARAM_SET packet_in{};
    packet_in.target_system = 223;
    packet_in.target_component = 34;
    packet_in.index = 18483;
    packet_in.mixer_group = 101;
    packet_in.mixer_index = 18587;
    packet_in.mixer_sub_index = 168;
    packet_in.mixer_type = 235;
    packet_in.parameter_index = 18691;
    packet_in.param_type = 46;
    packet_in.param_id = to_char_array("KLMNOPQRSTUVWXY");
    packet_in.param_values = {{ 17.0, 18.0, 19.0, 20.0, 21.0, 22.0 }};

    mavlink::common::msg::MIXER_PARAM_SET packet1{};
    mavlink::common::msg::MIXER_PARAM_SET packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, MIXER_PARAM_SET)
{
    mavlink_message_t msg;
    ...
    mavlink_mixer_param_set_t packet_c {
    ...
    mavlink_msg_mixer_param_set_encode(1, 1, &msg, &packet_c);
...
TEST(common, MIXER_PARAM_REQUEST_READ)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::MIXER_PARAM_REQUEST_READ packet_in{};
    packet_in.target_system = 151;
    packet_in.target_component = 218;
    packet_in.index = 17235;
    packet_in.mixer_group = 29;
    packet_in.mixer_index = 17339;
    packet_in.mixer_sub_index = 96;
    packet_in.parameter_index = 17443;
    packet_in.param_type = 163;
    packet_in.param_id = to_char_array("LMNOPQRSTUVWXYZ");

    mavlink::common::msg::MIXER_PARAM_REQUEST_READ packet1{};
    mavlink::common::msg::MIXER_PARAM_REQUEST_READ packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, MIXER_PARAM_REQUEST_READ)
{
    mavlink_message_t msg;
    ...
    mavlink_mixer_param_request_read_t packet_c {
    ...
    mavlink_msg_mixer_param_request_read_encode(1, 1, &msg, &packet_c);
