...
#define MAVLINK_MSG_ID_MIXER_PARAM_REQUEST_READ_LEN 28
#define MAVLINK_MSG_ID_MIXER_PARAM_REQUEST_READ_MIN_LEN 28
#define MAVLINK_MSG_ID_237_LEN 28
#define MAVLINK_MSG_ID_237_MIN_LEN 28

#define MAVLINK_MSG_ID_MIXER_PARAM_REQUEST_READ_CRC 142
#define MAVLINK_MSG_ID_237_CRC 142
...
#define MAVLINK_MESSAGE_INFO_MIXER_PARAM_REQUEST_READ { \
    ...
    {  { "index", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_mixer_param_request_read_t, index) }, \
         ...
         { "param_array_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 11, offsetof(mavlink_mixer_param_request_read_t, param_array_index) }, \
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 12, offsetof(mavlink_mixer_param_request_read_t, param_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MIXER_PARAM_REQUEST_READ { \
...
static inline uint16_t mavlink_msg_mixer_param_request_read_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint16_t index, uint8_t mixer_group, uint16_t mixer_index, uint8_t mixer_sub_index, uint16_t parameter_index, uint8_t param_type, uint8_t param_array_index, const char *param_id)
{
    ...
    _mav_put_uint8_t(buf, 11, param_array_index);
...
static inline void mavlink_msg_mixer_param_request_read_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t index, uint8_t mixer_group, uint16_t mixer_index, uint8_t mixer_sub_index, uint16_t parameter_index, uint8_t param_type, uint8_t param_array_index, const char *param_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MIXER_PARAM_REQUEST_READ_LEN];
    _mav_put_uint16_t(buf, 0, index);
 ...
 */
static inline void mavlink_msg_mixer_param_request_read_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t index, uint8_t mixer_group, uint16_t mixer_index, uint8_t mixer_sub_index, uint16_t parameter_index, uint8_t param_type, uint8_t param_array_index, const char *param_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field param_array_index from mixer_param_request_read message
 *
 * @return Array index
 */
static inline uint8_t mavlink_msg_mixer_param_request_read_get_param_array_index(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mixer_param_request_read_decode(const mavlink_message_t* msg, mavlink_mixer_param_request_read_t* mixer_param_request_read)
{
    ...
    mixer_param_request_read->param_array_index = mavlink_msg_mixer_param_request_read_get_param_array_index(msg);
