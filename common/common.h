...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_REQUEST_MIXER_STORE=4103, /* Request to send all mixer data.
                    |Mixer Group|  */
   MAV_CMD_REQUEST_MIXER_CONN=4104, /* Request information on a specific mixer connection
                    |Mixer Group| Mixer Index| Submixer Index| Connection Type| Connection Index|  */
