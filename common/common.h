...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_REQUEST_MIXER_PARAM_READ=4100, /* Request to send mixer data in a group and a given mixer, submixer, type and parameter index.
         |Index| Mixer Group| Mixer Index| Submixer Index| Parameter Index|  */
   MAV_CMD_REQUEST_MIXER_PARAM_LIST=4101, /* Request to send a list of all mixer data. |Mixer Group|  */
   MAV_CMD_SET_MIXER_PARAM=4102, /* Request to set mixer parameter by index or by mixer and parameter address
         |Index| Mixer Group| Mixer Index| Submixer Index| Parameter Index| Parameter array index| Parameter|  */
   MAV_CMD_SAVE_MIXER_PARAMS=4103, /* Save mixer parameters |Mixer Group|  */
...
/** @brief Identifies a set of mixers to access */
#ifndef HAVE_ENUM_MIXER_GROUP
#define HAVE_ENUM_MIXER_GROUP
typedef enum MIXER_GROUP
{
   MIXER_GROUP_NONE=0, /* No specific group selected | */
   MIXER_GROUP_LOCAL=1, /* Mixers on the local processor | */
   MIXER_GROUP_FAILSAFE=2, /* Mixers on a failsafe device | */
...
#include "./mavlink_msg_mixer_parameter.h"
