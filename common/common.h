...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_REQUEST_MIXER_DATA=4100, /* Request to send mixer data in a group and a given mixer, submixer, type and parameter index.
                   |Mixer Group| Mixer Index| Submixer Index| Parameter Index| Data type|  */
   MAV_CMD_REQUEST_MIXER_SEND_ALL=4101, /* Request to send all mixer data.
                     |Mixer Group|  */
   MAV_CMD_SET_MIXER_PARAMETER=4102, /* Set a mixer parameter value for a given group, mixer, submix and parameter index.
                    |Mixer Group| Mixer Index| Submixer Index| Parameter Index| Parameter Value|  */
   MAV_CMD_REQUEST_MIXER_STORE=4103, /* Request to send all mixer data.
                    |Mixer Group|  */
   MAV_CMD_REQUEST_MIXER_TYPE_COUNT=4110, /* Request count of mixer types
                     |Mixer Group|  */
   MAV_CMD_REQUEST_MIXER_TYPE_INDENTIFIER=4111, /* Request a mixer type identifier
                     |Mixer Group| Mixer type index|  */
   MAV_CMD_REQUEST_MIXER_PARAMETER_INDENTIFIER=4112, /* Request a mixer parameter identifier from a group, mixer and parameter index
                     |Mixer Group| Mixer type index| Mixer parameter index|  */
...
/** @brief Mixer data type */
#ifndef HAVE_ENUM_MIXER_DATA_TYPE
#define HAVE_ENUM_MIXER_DATA_TYPE
typedef enum MIXER_DATA_TYPE
{
   ...
   MIXER_DATA_TYPE_MIXERTYPE_COUNT=10, /* Count of mixer types for a given group | */
   MIXER_DATA_TYPE_PARAMETER_COUNT=11, /* Count of mixer parameters for a given mixer type in a group | */
   MIXER_DATA_TYPE_ENUM_END=12, /*  | */
} MIXER_DATA_TYPE;
#endif

/** @brief To determine where the mixers are located */
#ifndef HAVE_ENUM_MIXER_GROUP
#define HAVE_ENUM_MIXER_GROUP
typedef enum MIXER_GROUP
{
   MIXER_GROUP_LOCAL=0, /* Mixers on the local processor | */
   MIXER_GROUP_FAILSAFE=1, /* Mixers on a failsafe device | */
...
#include "./mavlink_msg_mixer_data.h"
#include "./mavlink_msg_mixer_meta_data.h"
#include "./mavlink_msg_mixer_identifier.h"
