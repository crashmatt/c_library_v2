...
/** @brief Flags for different parameter qualities and states */
#ifndef HAVE_ENUM_MIXER_PARAM_FLAGS
#define HAVE_ENUM_MIXER_PARAM_FLAGS
typedef enum MIXER_PARAM_FLAGS
{
   MIXER_PARAM_READ_ONLY=1, /* Parameter is read only | */
   MIXER_PARAM_FLAGS_ENUM_END=2, /*  | */
} MIXER_PARAM_FLAGS;
#endif
...
#include "./mavlink_msg_mixer_param_value.h"
#include "./mavlink_msg_mixer_param_set.h"
#include "./mavlink_msg_mixer_param_request_read.h"
