...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_REQUEST_MIXER_SEND_ALL=4101, /* Request to send all mixer data. |Mixer Group|  */
   MAV_CMD_SET_MIXER_PARAMETER=4102, /* Set a mixer parameter value for a given group, mixer, submix and parameter index. |Mixer Group| Mixer Index| Submixer Index| Parameter Index| Parameter Value|  */
   MAV_CMD_REQUEST_MIXER_STORE=4103, /* Request to send all mixer data. |Mixer Group|  */
   MAV_CMD_REQUEST_MIXER_CONN=4104, /* Request information on a specific mixer connection |Mixer Group| Mixer Index| Submixer Index| Connection Type| Connection Index|  */
...
/** @brief Type of mixer */
#ifndef HAVE_ENUM_MIXER_CONN_TYPE
#define HAVE_ENUM_MIXER_CONN_TYPE
typedef enum MIXER_CONN_TYPE
{
   MIXER_CONNECTION_OUTPUT=0, /* Mixer connection for output | */
