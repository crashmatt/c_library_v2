...
static void mavlink_test_mixer_data_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MIXER_DATA_REQUEST >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mixer_data_request_t packet_in = {
        5,72,139,206,17,84,151
    };
    mavlink_mixer_data_request_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MIXER_DATA_REQUEST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MIXER_DATA_REQUEST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_request_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mixer_data_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_request_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.data_type );
    mavlink_msg_mixer_data_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.data_type );
    mavlink_msg_mixer_data_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mixer_data_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_request_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.data_type );
    mavlink_msg_mixer_data_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mixer_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MIXER_DATA >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mixer_data_t packet_in = {
        963497464,45.0,29,96,163,230,41,108,175,242
    };
    mavlink_mixer_data_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.data_value = packet_in.data_value;
        packet1.param_value = packet_in.param_value;
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        packet1.mixer_group = packet_in.mixer_group;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MIXER_DATA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MIXER_DATA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mixer_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.data_type , packet1.data_value , packet1.param_value , packet1.param_type );
    mavlink_msg_mixer_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.data_type , packet1.data_value , packet1.param_value , packet1.param_type );
    mavlink_msg_mixer_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mixer_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_data_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.data_type , packet1.data_value , packet1.param_value , packet1.param_type );
    mavlink_msg_mixer_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mixer_parameter_set(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MIXER_PARAMETER_SET >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mixer_parameter_set_t packet_in = {
        17.0,17,84,151,218,29,96,163
    };
    mavlink_mixer_parameter_set_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.param_value = packet_in.param_value;
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MIXER_PARAMETER_SET_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MIXER_PARAMETER_SET_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_parameter_set_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mixer_parameter_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_parameter_set_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.param_value , packet1.param_type );
    mavlink_msg_mixer_parameter_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_parameter_set_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.param_value , packet1.param_type );
    mavlink_msg_mixer_parameter_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mixer_parameter_set_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mixer_parameter_set_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.mixer_group , packet1.mixer_index , packet1.mixer_sub_index , packet1.parameter_index , packet1.param_value , packet1.param_type );
    mavlink_msg_mixer_parameter_set_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_mixer_data_request(system_id, component_id, last_msg);
    mavlink_test_mixer_data(system_id, component_id, last_msg);
    mavlink_test_mixer_parameter_set(system_id, component_id, last_msg);
}
