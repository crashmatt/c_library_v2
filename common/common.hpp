...
enum class MAV_CMD : uint16_t
{
    ...
    REQUEST_MIXER_PARAM_LIST=4101, /* Request to send a list of all mixer data. |Mixer Group|  */
    SAVE_MIXER_PARAMS=4103, /* Save mixer parameters |Mixer Group|  */
...
enum class MIXER_GROUP : uint8_t
{
    NONE=0, /* No specific group selected | */
    LOCAL=1, /* Mixers on the local processor | */
    FAILSAFE=2, /* Mixers on a failsafe device | */
};

//! MIXER_GROUP ENUM_END
constexpr auto MIXER_GROUP_ENUM_END = 3;

/** @brief Flags for different parameter qualities and states */
enum class MIXER_PARAM_FLAGS : uint8_t
{
    READ_ONLY=1, /* Parameter is read only | */
};

//! MIXER_PARAM_FLAGS ENUM_END
constexpr auto MIXER_PARAM_FLAGS_ENUM_END = 2;
...
#include "./mavlink_msg_mixer_param_value.hpp"
#include "./mavlink_msg_mixer_param_set.hpp"
#include "./mavlink_msg_mixer_param_request_read.hpp"
